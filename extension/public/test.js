    ...
    function(request, sender,) {
      Swal.fire({
        ...
        .then((res) => {
          ...
          left=Swal.getHtmlContainer().querySelector('.fc-progress-left .fc-progress-bar');
          right=Swal.getHtmlContainer().querySelector('.fc-progress-right .fc-progress-bar');
